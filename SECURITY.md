...
`Detection Rule Classifier` project.
...
The `Detection Rule Classifier` maintainers take all security issues in the
project seriously. Thank you for improving the security of
`Detection Rule Classifier`. We appreciate your dedication to responsible
disclosure and will make every effort to acknowledge your contributions.

`Detection Rule Classifier` leverages GitHub's private vulnerability reporting.
